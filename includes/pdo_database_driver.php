 ...
 *
 * @param string $db_host The MySQL server. It can also include a port number. e.g. "hostname:port" or a path to a
 *                        local socket e.g. ":/path/to/socket" for the localhost. If the PHP directive
 *                        mysql.default_host is undefined (default), then the default value is 'localhost:3306'. In SQL
 *                        safe mode, this parameter is ignored and value 'localhost:3306' is always used.
 * @param string $db_user The username. Default value is defined by mysql.default_user.
 *                        In SQL safe mode, this parameter is ignored and the name of the user that owns the server
 *                        process is used.
...
/**
 * Counts records by $field (can be all fields if this value is (*) ) from $table in some $conditions (default no
 * conditions) written in SQL syntax.
 *
 ...
 * @param resource $query
 *
 * @return array Returns an associative array of strings that corresponds to the fetched row, or FALSE if there are no
 *               more rows.
 */
 ...
 *
 * @return array Returns an numerical array of strings that corresponds to the fetched row, or FALSE if there are no
 *               more rows.
 */
 ...
 *
 * @return string $id Returns the ID of the last inserted row, or the last value from a sequence object, depending on
